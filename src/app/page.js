    ...
    <div style={{ maxWidth: "1440px", margin: "auto" }}>
      <section className="default-padding">
        <TopSection
          imagePosition={"right"}
          isContainer={false}
          componentText={homeData.Section1}
        />
      </section>
      <section className="default-padding">
      ...
      <section style={{ padding: 0 }}>
        <SustainableReporting
          isContainer={false}
          heading={homeData.Section3.Heading}
          text={homeData.Section3.Text}
          imageUrl={homeData.Section3.imageSrc}
        />
      </section>
      <section className="default-padding">
        <CenterHeadingPara
          data={homeData.Section4}
          hasTitle={true}
      ...
      <section className="default-padding">
        <ImageText
          componentText={homeData.Section8.element1}
          imagePosition={"right"}
        />
      </section>
      <section className="default-padding">
        <ImageText
          componentText={homeData.Section8.element2}
          imagePosition={"left"}
        />
      </section>
      <section>
